...
public class ZooManagement extends ZooFullException {
    ...
    public ZooManagement(String name, String city) {
    ...
    public static ZooManagement comparerZoo(ZooManagement z1, ZooManagement z2) {
    ...
    public void addAnimal(Animal animal) throws ZooFullException, InvalidAgeException {
        ...
        if (nbrAnimals >= animals.length) {
            throw new ZooFullException(); // Lance l'exception si le zoo est plein
        }
        if (animal.getAge()< 0) {
