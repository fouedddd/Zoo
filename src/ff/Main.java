...
public class Main {
    ...
    public static void main(String[] args) throws ZooFullException, InvalidAgeException {
        ...
        ZooManagement myZoo = new ZooManagement("Wildlife Park", "Ariana");
        ZooManagement notMyZoo = new ZooManagement("WaterPark", "Siliana");


        Animal dog = new Animal("Canine", "Snoopy", 2, true);
          Animal elephant= new Animal("sauvage", "loulou", 100, true);
        Animal oisaux= new Animal("sauvage", "zzzzzz", 150, true);
        Animal poisson= new Animal("sauvage","snoupy",-10,true);
//
      // myZoo.addAnimal(lion);
      // myZoo.addAnimal(elephant);
      // myZoo.addAnimal(oisaux);
